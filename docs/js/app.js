    ...
    (() => {
        ...
        function formSubmit() {
            ...
            function formSent(form, responseResult = ``) {
                ...
                if (fileErrorSpan) fileErrorSpan.textContent = "";
                formValidate.formClean(form);
        ...
        function initSliders() {
            if (document.querySelector(".companies__slider")) new swiper_core_Swiper(".companies__slider", {
            ...
            if (document.querySelector(".news-slider__slider")) new swiper_core_Swiper(".news-slider__slider", {
                modules: [ Navigation, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
                ...
                filterButtons.forEach((function(button) {
                    button.addEventListener("click", (function() {
                        ...
                        if (filterValue === "*") itemsGrid.arrange({
                            filter: '[data-iso-item]:not([data-filter="empty"])'
            ...
            if (fileInputBodies.length > 0) fileInputBodies.forEach((fileInputBody => {
                ...
                if (fileInput) fileInput.addEventListener("change", (function(event) {
                    if (this.files && this.files.length > 0) {
                        ...
                        if (fileSizeInMB > 10) {
                            ...
                            if (!fileInputBody.classList.contains("_upload")) fileInputBody.classList.add("_upload");
